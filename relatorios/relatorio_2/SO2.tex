...
\section{Código e Comparação de Desempenho}

O código a seguir demonstra uma comparação de desempenho entre o uso de primitivas `fork` e threads para realizar tarefas concorrentes. O programa executa 20 simulações para medir o tempo médio de execução em ambas as abordagens.
