...
\usepackage{graphicx}			% I%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%nclusão de gráficos
...
O programa em C, na figura \ref{fig:proc7}, exemplifica o que ocorre quando um programa tenta criar um número muito maior do que o limite de threads maximas do sistema. A imagem  \ref{fig:run7_2}, mostra o resultado do codigo da figura \ref{fig:proc7}.
\begin{figure}
    \centering
